        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="{{ url('/') }}"> EnviroClean</a>
                </div>
                <!-- /.navbar-header -->
                    ...
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
                                ...
                                <a href="#" style="color:green"><i class="fa fa-user fa-fw"></i> Employees</a>
                                @else
                                <a href="{{ url('user') }}"><i class="fa fa-user fa-fw"></i> Employees</a>
                                @endif
                            </li>
                            <li>
